...
chr_dxa_data <-
  read_excel("data/tr036_dxa_all_data_22.20.24.xlsx", na = "na") %>% 
  
  select(id, period, timepoint, Dato, `VAT-masse`, `VAT-volum`, `Bein BMC`, `Kropp BMC`, `Hele BMC`, `Total venstre BMC`, `Total hoyre BMC`, `Bein Beinmasse`, `Kropp Beinmasse`, `Hele Beinmasse`, `Total hoyre Beinmasse`, `Total venstre Beinmasse`, `Armer Fettmasse`, `Arm hoyre Fettmasse`, `Arm venstre Fettmasse`, `Bein Fettmasse`, `Bein hoyre Fettmasse`, `Bein venstre Fettmasse`, `Kropp Fettmasse`, `Overkropp hoyre Fettmasse`, `Overkropp venstre Fettmasse`, `Android Fettmasse`, `Gynoid Fettmasse`, `Hele Fettmasse`, `Total hoyre Fettmasse`, `Total venstre Fettmasse`, `Armer Mager masse`, `Arm hoyre Mager masse`, `Arm venstre Mager masse`, `Bein Mager masse`, `Bein hoyre Mager masse`, `Bein venstre Mager masse`, `Kropp Mager masse`, `Overkropp hoyre Mager masse`, `Overkropp venstre Mager masse`, `Android Mager masse`, `Gynoid Mager masse`, `Hele Mager masse`, `Total hoyre Mager masse`, `Total venstre Mager masse`, `Armer Vevmasse`, `Arm hoyre Vevmasse`,`Arm venstre Vevmasse`, `Bein Vevmasse`, `Bein hoyre Vevmasse`, `Bein venstre Vevmasse`, `Kropp Vevmasse`, `Overkropp hoyre Vevmasse`, `Overkropp venstre Vevmasse`, `Android Vevmasse`, `Gynoid Vevmasse`, `Hele Vevmasse`, `Total hoyre Vevmasse`, `Total venstre Vevmasse`, `Armer Fettfri masse`, `Arm hoyre Fettfri masse`, `Arm venstre Fettfri masse`, `Bein Fettfri masse`, `Bein hoyre Fettfri masse`, `Bein venstre Fettfri masse`, `Kropp Fettfri masse`, `Overkropp hoyre Fettfri masse`, `Overkropp venstre Fettfri masse`, `Android Fettfri masse`, `Gynoid Fettfri masse`, `Hele Fettfri masse`, `Total hoyre Fettfri masse`, `Total venstre Fettfri masse`, `Armer Total masse`, `Arm hoyre Total masse`, `Arm venstre Total masse`, `Bein Total masse`, `Bein hoyre Total masse`, `Bein venstre Total masse`, `Kropp Total masse`, `Overkropp hoyre Total masse`, `Overkropp venstre Total masse`, `Android Total masse`, `Gynoid Total masse`, `Hele Total masse`, `Total hoyre Total masse`, `Total venstre Total masse`) %>% 
    
  pivot_longer(names_to = "variable", values_to = "value", cols = `VAT-masse`:`Total venstre Total masse`) %>% 
...
dbl_dxa_data <- read_excel("data/tr036_dxa_all_data_22.20.24.xlsx", na = "na") %>%
  
  select(-`VAT-masse`, -`VAT-volum`, -`Bein BMC`, -`Kropp BMC`, -`Hele BMC`, -`Total venstre BMC`, -`Total hoyre BMC`, -`Bein Beinmasse`, -`Kropp Beinmasse`, -`Hele Beinmasse`, -`Total hoyre Beinmasse`, -`Total venstre Beinmasse`, -`Armer Fettmasse`, -`Arm hoyre Fettmasse`, -`Arm venstre Fettmasse`, -`Bein Fettmasse`, -`Bein hoyre Fettmasse`, -`Bein venstre Fettmasse`, -`Kropp Fettmasse`, -`Overkropp hoyre Fettmasse`, -`Overkropp venstre Fettmasse`, -`Android Fettmasse`, -`Gynoid Fettmasse`, -`Hele Fettmasse`, -`Total hoyre Fettmasse`, -`Total venstre Fettmasse`, -`Armer Mager masse`, -`Arm hoyre Mager masse`, -`Arm venstre Mager masse`, -`Bein Mager masse`, -`Bein hoyre Mager masse`, -`Bein venstre Mager masse`, -`Kropp Mager masse`, -`Overkropp hoyre Mager masse`, -`Overkropp venstre Mager masse`, -`Android Mager masse`, -`Gynoid Mager masse`, -`Hele Mager masse`, -`Total hoyre Mager masse`, -`Total venstre Mager masse`, -`Armer Vevmasse`, -`Arm hoyre Vevmasse`, -`Arm venstre Vevmasse`, -`Bein Vevmasse`, -`Bein hoyre Vevmasse`, -`Bein venstre Vevmasse`, -`Kropp Vevmasse`, -`Overkropp hoyre Vevmasse`, -`Overkropp venstre Vevmasse`, -`Android Vevmasse`, -`Gynoid Vevmasse`, -`Hele Vevmasse`, -`Total hoyre Vevmasse`, -`Total venstre Vevmasse`, -`Armer Fettfri masse`, -`Arm hoyre Fettfri masse`, -`Arm venstre Fettfri masse`, -`Bein Fettfri masse`, -`Bein hoyre Fettfri masse`, -`Bein venstre Fettfri masse`, -`Kropp Fettfri masse`, -`Overkropp hoyre Fettfri masse`, -`Overkropp venstre Fettfri masse`, -`Android Fettfri masse`, -`Gynoid Fettfri masse`, -`Hele Fettfri masse`, -`Total hoyre Fettfri masse`, -`Total venstre Fettfri masse`, -`Armer Total masse`, -`Arm hoyre Total masse`, -`Arm venstre Total masse`, -`Bein Total masse`, -`Bein hoyre Total masse`, -`Bein venstre Total masse`, -`Kropp Total masse`, -`Overkropp hoyre Total masse`, -`Overkropp venstre Total masse`, -`Android Total masse`, -`Gynoid Total masse`, -`Hele Total masse`, -`Total hoyre Total masse`, -`Total venstre Total masse`, -`TBLH BMD`, -`TBLH BMC`, -`TBLH Total masse`, -`TBLH Beinmasse`, -`TBLH Fettmasse`, -`TBLH Mager masse`, -`TBLH Vevmasse`, -`TBLH Fettfri masse`, -`Total venstre Total masse`, -`TBLH Omrade %fett`, -`TBLH Vev %fett`) %>% 
  
  pivot_longer(names_to = "variable", values_to = "value", cols = `Alder`:`Total venstre Vev %fett`) %>%
  full_join(chr_dxa_data) %>% 
